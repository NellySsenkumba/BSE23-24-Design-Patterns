...
public class Client {
        public static void main(String[] args) {
                ...
                // System.out.println(
                //                 "The updated price (With Wrapping) is " + wrapped_phone.getPrice()
                //                                 + wrapped_phone.getDescription());
                ...
                // cart.addProduct(new Electronic("Speaker", 400000, "JBL", 10));
                        ...
                        ProductCatalog cart1= new ProductCatalog();
                        Salesperson mariam = new Salesperson("Mariam");
                        cart1.attach(mariam);
                        cart1.addProduct(new Clothing("Pants", 2000, "Jeans", 5));

                        ProductCatalog cart2= new ProductCatalog();
                        Salesperson Aaron = new Salesperson("Aaron");
                        cart2.attach(Aaron);
                        cart2.addProduct(new Groceries("Oranges", 500, "Ripe", 20));
                        cart1.addProduct(new Groceries("Oranges", 500, "Ripe", 20));


                        cart1.addProduct(new Clothing("Skirt", 2000, "Jeans", 5));
                        cart1.addProduct(new Clothing("Shirt", 2000, "Jeans", 5));
